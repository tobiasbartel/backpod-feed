...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('url', models.URLField(db_index=True, default=None, null=True)),
                ...
                ('itunes_block', models.NullBooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object_hash', models.CharField(db_index=True, max_length=50)),
                ('comments', models.URLField(blank=True, null=True)),
                ('creative_commons', models.CharField(blank=True, max_length=250, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('enclosure_url', models.URLField(blank=True, db_index=True, null=True)),
                ...
                ('guid', models.CharField(blank=True, db_index=True, max_length=250, null=True)),
                ('itunes_block', models.NullBooleanField(default=False)),
                ('itunes_closed_captioned', models.CharField(blank=True, max_length=250, null=True)),
                ('itunes_duration', models.CharField(blank=True, max_length=250, null=True)),
                ('itunes_explicit', models.CharField(blank=True, max_length=250, null=True)),
                ('itunes_image', models.URLField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lower_name', models.CharField(blank=True, db_index=True, max_length=250, null=True)),
        ...
        migrations.AddField(
            model_name='feed',
            name='itunes_directory',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='directory.Itunes'),
        ),
        migrations.AddField(
            model_name='feed',
